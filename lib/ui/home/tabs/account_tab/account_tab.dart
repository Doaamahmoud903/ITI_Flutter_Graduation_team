    ...
    return Scaffold(
      body: SafeArea(
        child: Column(
          ...
          children: [
            Image.asset(themeProvider.currentTheme == ThemeMode.light
            ...
            width: 200,),
            Padding(
              padding: languageProvider.currentLocal == "en"
            ...
            SettingsItem(
              ...
              trailingText: languageProvider.currentLocal == "en" ?"English" : "العربيه",
              onTap: () => {
                showLanguageDropdownList(themeProvider)
              },
            ),
            Divider(indent: 20, endIndent: 20, thickness: 0.5 ,
              color: themeProvider.currentTheme == ThemeMode.dark
            ...
            SettingsItem(
              ...
              trailingText: themeProvider.currentTheme == ThemeMode.light
                  ? (languageProvider.currentLocal == "en" ? "Light" : "فاتح")
                  : (languageProvider.currentLocal == "en" ? "Dark" : "داكن"),
              onTap: () => {
            ...
            SettingsItem(title: AppLocalizations.of(context)!.logout, 
                onTap: () =>
        ...
        actions: [
          ...
          TextButton(
            onPressed: () async {
              ...
              await storageService.clearToken(); // delete token from SharedPreferences
