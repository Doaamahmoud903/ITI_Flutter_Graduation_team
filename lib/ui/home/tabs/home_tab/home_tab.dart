...
class _HomeTabState extends State<HomeTab> {
  ...
  Future<List<CategoryModel>> fetchCategories() async {
    return await categoryService
        .getAllCategories(); // Make sure to return the fetched categories
  }
          ...
          child: Column(
            children: [
              CarouselWidget(
                items: [
                  HomeCarousalItem(
                    img: AppAssets.carousel2,
                    right: 0,
                    left: 40,
                  ),
                  HomeCarousalItem(
                    img: AppAssets.carousel1,
                    right: 40,
                    left: 0,
                  ),
                  HomeCarousalItem(
                    img: AppAssets.carousel3,
                    right: 0,
                    left: 40,
                  ),
                ],
                    ...
                    return SizedBox(
                      ...
                      child: GridView.builder(
                        gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                          crossAxisCount:
                              4, // Two columns each colum has 4 items
                          crossAxisSpacing: 2,
                          mainAxisSpacing: 2,
